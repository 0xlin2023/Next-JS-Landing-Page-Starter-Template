          ...
          <table className="w-full min-w-[1200px] border-collapse">
            ...
            <thead>
              ...
              <tr className="bg-apple-blue text-white">
                ...
                {[
                  2.2, 2.3, 2.7, 2.8, 2.9, 3.0, 3.1, 3.2, 3.3, 3.4, 3.5, 3.6,
                  3.7, 3.8, 3.9, 4.0, 4.1, 4.2, 4.3, 4.5, 4.7, 4.9, 5.1, 5.3,
                  5.5, 5.7,
                ].map((dia, index) => (
                  <th
                    key={index}
            ...
            <tbody>
              ...
              <tr className="bg-apple-blue text-white">
                ...
                {['L5-49', 'L5-51', 'L5-53', 'L5-55', 'L5-57'].map(
                  (code, index) => (
                    <td
                      key={index}
                      className="border border-gray-300 px-1 py-2 text-center text-xs font-medium"
              ...
              <tr className="border-b-4 border-apple-blue bg-apple-blue text-white">
                ...
                {['L6-49', 'L6-51', 'L6-53', 'L6-55', 'L6-57'].map(
                  (code, index) => (
                    <td
                      key={index}
                      className="border border-gray-300 px-1 py-2 text-center text-xs font-medium"
