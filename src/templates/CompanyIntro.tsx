            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-lg leading-relaxed text-gray-700">
                <p>
                  {t('company.description1')
                    .split('。')
                    .map((sentence, index) => {
                      if (sentence.includes('普通碳钢')) {
                        return (
                          <span key={index}>
                            {sentence.split('普通碳钢')[0]}
                            <span className="font-semibold text-gray-900">
                              普通碳钢、不锈钢及复合螺丝
                            </span>
                            {sentence.split('普通碳钢')[1]}。
                          </span>
                        );
                      }
                      return (
                        sentence +
                        (index <
                        t('company.description1').split('。').length - 1
                          ? '。'
                          : '')
                      );
                    })}
                ...
                <p>
                  {t('company.description3')
                    .split('。')
                    .map((sentence, index) => {
                      if (sentence.includes('欧美及亚洲')) {
                        return (
                          <span key={index}>
                            {sentence.split('欧美及亚洲')[0]}
                            <span className="font-semibold text-apple-blue">
                              欧美及亚洲等高需求市场
                            </span>
                            {sentence.split('欧美及亚洲')[1]}。
                          </span>
                        );
                      }
                      return (
                        sentence +
                        (index <
                        t('company.description3').split('。').length - 1
                          ? '。'
                          : '')
                      );
                    })}
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="flex items-center gap-3 rounded-apple bg-white p-4 shadow-apple">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">
                      {t('company.feature1.title')}
                    </p>
                    <p className="text-sm text-gray-600">
                      {t('company.feature1.subtitle')}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 rounded-apple bg-white p-4 shadow-apple">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">
                      {t('company.feature2.title')}
                    </p>
                    <p className="text-sm text-gray-600">
                      {t('company.feature2.subtitle')}
                    </p>
                  </div>
                </div>
              </div>
